...
void
shNCursesInterface::cursorOnXY (int x, int y, int curstype)
...
void
shNCursesInterface::newTempWin ()
{
    mPan[kTemp] = new_panel (mWin[kTemp]);
    update_panels ();
}
...
void
shNCursesInterface::drawMem (int x, int y, shSpecialEffect e, shCreature *c,
