...
const char *glb_encyclopedia_entry_kObjRabbitFoot_lines[] =
{
    ...
    "of rabbits are extant and they're probably putting together",
    "some sort of galactic domination agenda.  Which no doubt will",
    "come to fruition since each of them, after all, has four",
    "rabbit feet."
};
...
const char *glb_encyclopedia_entry_kObjGenericKeycard_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericKeycard =
{
    kObjGenericKeycard,
    "keycard",
    11,
    glb_encyclopedia_entry_kObjGenericKeycard_lines
};

const char *glb_encyclopedia_entry_kObjGenericTool_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericTool =
{
    kObjGenericTool,
    "tool",
    6,
    glb_encyclopedia_entry_kObjGenericTool_lines
};
...
{
    "The monkey wrench makes the ideal tool for fixing",
    "things or clubbing someone over the head.  Its",
    "enhancement counts as bonus (or malus) for both",
    "actions."
};
...
const char *glb_encyclopedia_entry_kObjPortableHole_lines[] =
{
    ...
    "hole from other angles will cause the generator to attempt a",
    "connect in the wrong direction.  This will cause a failure,",
    "destroying the hole.",
    "",
...
const char *glb_encyclopedia_entry_kObjTricorder_lines[] =
{
    ...
    "scan requires nine energy cells.  The tricorder is versatile",
    "enough to scan other objects of interest as well."
};
...
const char *glb_encyclopedia_entry_kObjGenericEnergyTank_lines[] =
{
    ...
    "Large energy tank weight equals weight of 200 cells.",
    "",
    "It is not possible to move charges between tanks without",
    "the application of a transfer cable."
};

const encyclopedia_entry glb_encyclopedia_entry_kObjGenericEnergyTank =
{
    kObjGenericEnergyTank,
    "energy tank",
    10,
    glb_encyclopedia_entry_kObjGenericEnergyTank_lines
};
...
const char *glb_encyclopedia_entry_kObjLargeEnergyTank_lines[] =
{
    ...
    "",
    "After a short but uncomfortable parlay a contract was signed. And so",
    "now we have standardized energy tanks."
};
...
const char *glb_encyclopedia_entry_kObjGenericImplant_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericImplant =
{
    kObjGenericImplant,
    "bionic implant",
    21,
    glb_encyclopedia_entry_kObjGenericImplant_lines
};
...
const char *glb_encyclopedia_entry_kObjGenericSkillsoft_lines[] =
{
    "Skillsofts are special variety of cranial bionic implants.",
    "Instead of manipulating hormone production of your brain,",
    "or affecting some of its functions, it only does one thing:",
    "provides you with a knowledge database.  The impact on",
    "psionic aura is less in comparison to other cranial implants.",
    "",
    "",
    "Effective skill increase varies according to bionic status:",
    "",
    "Status       Skill",
    "Buggy..........+0",
    "Debugged.......+4",
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericSkillsoft =
{
    kObjGenericSkillsoft,
    "skillsoft",
    13,
    glb_encyclopedia_entry_kObjGenericSkillsoft_lines
};
...
const char *glb_encyclopedia_entry_kObjGloryDevice_lines[] =
{
    ...
    "reused for miniature cranial bionic implants that activate",
...
const char *glb_encyclopedia_entry_kObjMechaDendrites_lines[] =
{
    ...
    "with computers in a more direct way.  To benefit from the",
    "enhanced computer interface you need to know at least a bit",
    "about programming.",
    "",
...
const char *glb_encyclopedia_entry_kObjGenericCanister_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericCanister =
{
    kObjGenericCanister,
    "canister",
    23,
    glb_encyclopedia_entry_kObjGenericCanister_lines
};
...
const char *glb_encyclopedia_entry_kObjFirstRayGun_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjFirstRayGun =
{
    kObjFirstRayGun,
    "ray gun preamble",
    3,
    glb_encyclopedia_entry_kObjFirstRayGun_lines
};

const char *glb_encyclopedia_entry_kObjLastRayGun_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjLastRayGun =
{
    kObjLastRayGun,
    "unidentified ray gun",
    3,
    glb_encyclopedia_entry_kObjLastRayGun_lines
};
...
const char *glb_encyclopedia_entry_kObjElvenCombatArmor_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjElvenCombatArmor =
{
    kObjElvenCombatArmor,
    "elven combat armor",
    5,
    glb_encyclopedia_entry_kObjElvenCombatArmor_lines
};

const char *glb_encyclopedia_entry_kObjElvenExarchArmor_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjElvenExarchArmor =
{
    kObjElvenExarchArmor,
    "elven exarch armor",
    3,
    glb_encyclopedia_entry_kObjElvenExarchArmor_lines
};
...
const char *glb_encyclopedia_entry_kObjStormtrooperHelmet_lines[] =
{
    ...
    "worse the helmet's visors are also too small, also hindering",
    "the wearer's sight."
};
...
const char *glb_encyclopedia_entry_kObjElvenCombatHelmet_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjElvenCombatHelmet =
{
    kObjElvenCombatHelmet,
    "elven combat helmet",
    3,
    glb_encyclopedia_entry_kObjElvenCombatHelmet_lines
};

const char *glb_encyclopedia_entry_kObjElvenExarchHelmet_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjElvenExarchHelmet =
{
    kObjElvenExarchHelmet,
    "elven exarch helmet",
    3,
    glb_encyclopedia_entry_kObjElvenExarchHelmet_lines
};
...
const char *glb_encyclopedia_entry_kObjGenericBelt_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericBelt =
{
    kObjGenericBelt,
    "belt",
    5,
    glb_encyclopedia_entry_kObjGenericBelt_lines
};
...
const char *glb_encyclopedia_entry_kObjShieldBelt_lines[] =
{
    ...
    "part of the belt is very fragile.  If damaged you may not be able to",
    "activate or deactivate the belt.  This could put a drain on one's",
    "energy supply.  If your shield fizzles out the belt will be deactivated."
};
...
const char *glb_encyclopedia_entry_kObjPerilGoggles_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjPerilGoggles =
{
    kObjPerilGoggles,
    "pair of peril-sensitive sunglasses",
    5,
    glb_encyclopedia_entry_kObjPerilGoggles_lines
};
...
const char *glb_encyclopedia_entry_kObjAnyWeapon_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjAnyWeapon =
{
    kObjAnyWeapon,
    "weapon",
    17,
    glb_encyclopedia_entry_kObjAnyWeapon_lines
};
...
const char *glb_encyclopedia_entry_kObjKhanHeavyPistol_lines[] =
{
    ...
    "  [ DeadCold roguelike by Joseph Hewitt ]",
    "",
    "j::LightFlamethrower - light flamethrower",
...
const char *glb_encyclopedia_entry_kObjPistol_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjPistol =
{
    kObjPistol,
    "conventional pistol",
    4,
    glb_encyclopedia_entry_kObjPistol_lines
};
...
const char *glb_encyclopedia_entry_kObjGenericEnergyGun_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericEnergyGun =
{
    kObjGenericEnergyGun,
    "energy gun",
    13,
    glb_encyclopedia_entry_kObjGenericEnergyGun_lines
};

const char *glb_encyclopedia_entry_kObjBlaster_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjBlaster =
{
    kObjBlaster,
    "blaster pistol",
    10,
    glb_encyclopedia_entry_kObjBlaster_lines
};

const char *glb_encyclopedia_entry_kObjPhaser_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjPhaser =
{
    kObjPhaser,
    "phaser pistol",
    16,
    glb_encyclopedia_entry_kObjPhaser_lines
};
...
const char *glb_encyclopedia_entry_kObjGenericGrenade_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericGrenade =
{
    kObjGenericGrenade,
    "grenade",
    11,
    glb_encyclopedia_entry_kObjGenericGrenade_lines
};
...
const char *glb_encyclopedia_entry_kObjGenericAmmunition_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericAmmunition =
{
    kObjGenericAmmunition,
    "ammunition",
    3,
    glb_encyclopedia_entry_kObjGenericAmmunition_lines
};
...
const char *glb_encyclopedia_entry_kObjFuelDrum_lines[] =
{
...
const encyclopedia_entry glb_encyclopedia_entry_kObjFuelDrum =
{
    kObjFuelDrum,
    "fuel drum",
    3,
    glb_encyclopedia_entry_kObjFuelDrum_lines
};
...
const char *glb_encyclopedia_entry_kObjSpearheadDart_lines[] =
{
    ...
    "hunting tool.  It is likely to pierce target and",
    "continue flight."
};
...
{
    "This program is for finding bugs.  Probably this",
    "refers to software bugs, but who knows?"
};
...
const char *glb_encyclopedia_entry_kObjIdentifyDisk_lines[] =
{
    ...
    "purpose and quality of any object in the known universe.  Not",
...
const char *glb_encyclopedia_entry_kObjGenericComputer_lines[] =
{
    ...
    "| -3 | Terrible  | As above but 2/3 chance. Voice interface support. |",
    "| -2 | Bad       | As above but 3/4 chance.                          |",
    "| -1 | Poor      | Adds full user input correction.                  |",
    "|  0 | Average   | Supports hypodermic nerve interface.              |",
...
const encyclopedia_entry glb_encyclopedia_entry_kObjGenericComputer =
{
    kObjGenericComputer,
    "computer",
    32,
    glb_encyclopedia_entry_kObjGenericComputer_lines
};
...
const encyclopedia_entry *glb_encyclopedia_book_kObj_entrylist[] =
{
    ...
    &glb_encyclopedia_entry_kObjGenericKeycard,
    &glb_encyclopedia_entry_kObjGenericTool,
    ...
    &glb_encyclopedia_entry_kObjGenericEnergyTank,
    ...
    &glb_encyclopedia_entry_kObjGenericImplant,
    ...
    &glb_encyclopedia_entry_kObjGenericSkillsoft,
    ...
    &glb_encyclopedia_entry_kObjGenericCanister,
    ...
    &glb_encyclopedia_entry_kObjFirstRayGun,
    &glb_encyclopedia_entry_kObjLastRayGun,
    ...
    &glb_encyclopedia_entry_kObjElvenCombatArmor,
    &glb_encyclopedia_entry_kObjElvenExarchArmor,
    ...
    &glb_encyclopedia_entry_kObjElvenCombatHelmet,
    &glb_encyclopedia_entry_kObjElvenExarchHelmet,
    ...
    &glb_encyclopedia_entry_kObjGenericBelt,
    ...
    &glb_encyclopedia_entry_kObjPerilGoggles,
    ...
    &glb_encyclopedia_entry_kObjAnyWeapon,
    ...
    &glb_encyclopedia_entry_kObjPistol,
    ...
    &glb_encyclopedia_entry_kObjGenericEnergyGun,
    &glb_encyclopedia_entry_kObjBlaster,
    &glb_encyclopedia_entry_kObjPhaser,
    ...
    &glb_encyclopedia_entry_kObjGenericGrenade,
    ...
    &glb_encyclopedia_entry_kObjGenericComputer
};
...
const char *glb_encyclopedia_entry_kMonHighPingBastard_lines[] =
{
    ...
    "prefer to call it that - slow reflexes.  Thus they rarely get",
    "something better than a shotgun and some armor."
};
...
const char *glb_encyclopedia_entry_kMonLowPingBastard_lines[] =
{
    ...
    "a railgun and fine kevlar in addition to a shotgun."
};
...
const char *glb_encyclopedia_entry_kMonKillerRabbit_lines[] =
{
    ...
    "      Written and directed by Moty Python group. ]"
};
...
const char *glb_encyclopedia_entry_kMonHydralisk_lines[] =
{
    ...
    "Psiweapon: O_o",
    "Angry mob of SC1 fans: Shut up!  Liar!  It does not matter!  Away with you!",
    "Michal:  <_<  >_>  <_<",
